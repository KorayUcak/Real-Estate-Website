        ...
        <article>
          ...
          <div className="container-page grid gap-16 pb-section pt-20 lg:grid-cols-12">
            ...
            >
              ...
              <InlineCta
                title="Ready to look at actual properties?"
                text="Every villa on our books has been walked by us in person and has a clean individual title deed. Tell us what you need and we will send the shortlist."
                ctaLabel="Browse villas for sale"
                ctaHref="/properties"
              />
